...
bool dae::ResourceManager::GetVerticesFromSvgFile(const std::string& filePath, std::vector<std::vector<glm::vec2>>& vertices, glm::vec2 modifier, glm::vec2 offset)
{
	// Open the file
...
void dae::ResourceManager::RemoveSpaces(std::string& svgString)
{
...
bool dae::ResourceManager::GetVerticesFromSvgString(std::string& svgString, std::vector<std::vector<glm::vec2>>& vertices)
{
...
bool dae::ResourceManager::GetVerticesFromPathData(const std::string& pathData, std::vector<glm::vec2>& vertices)
{
...
bool dae::ResourceManager::GetElementContent(const std::string& svgText, const std::string& elementName, std::string& elementContent, size_t& startContentPos, size_t& endContentPos)
{
	// 2 possible formats
...
bool dae::ResourceManager::GetAttributeValue(const std::string& svgText, const std::string& attributeName, std::string& attributeValue)
{
...
// TODO: Test cases!
void dae::ResourceManager::SkipSvgComma(std::stringstream& svgStream, bool isRequired)
{
	while (true)
	{
...
float dae::ResourceManager::ReadSvgValue(std::stringstream& svgStream, float defaultValue)
{
	float s{};
	svgStream >> s;
...
float dae::ResourceManager::ReadSvgValue(std::stringstream& svgStream, bool separatorRequired)
{
	float s{};
	svgStream >> s;
...
glm::vec2 dae::ResourceManager::ReadSvgPoint(std::stringstream& svgStream)
{
...
glm::vec2 dae::ResourceManager::FirstSvgPoint(std::stringstream& svgStream, glm::vec2& cursor, char cmd, bool isOpen, bool advance)
{
	if (!isOpen)
	{
...
glm::vec2 dae::ResourceManager::NextSvgPoint(std::stringstream& svgStream, glm::vec2& cursor, char cmd, bool isOpen, bool advance)
{
	if (isOpen)
	{
...
glm::vec2 dae::ResourceManager::NextSvgCoordX(std::stringstream& svgStream, glm::vec2& cursor, char cmd, bool isOpen)
{
	if (isOpen)
	{
...
glm::vec2 dae::ResourceManager::NextSvgCoordY(std::stringstream& svgStream, glm::vec2& cursor, char cmd, bool isOpen)
{
	if (isOpen)
	{
