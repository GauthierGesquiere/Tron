...
dae::TextRendererComponent::TextRendererComponent(const std::string& text, const std::shared_ptr<Font>& font) 
	: m_NeedsUpdate(true), m_Text(text), m_Font(font), m_TextTexture(nullptr)
{ }

void dae::TextRendererComponent::Startup()
{
	Component::Startup();
}

void dae::TextRendererComponent::Update(float /*deltaSec*/)
{
	if (m_NeedsUpdate)
	{
